  ...
  return (
    <div className="min-h-screen bg-[#070711] flex items-center justify-center px-4 py-10 overflow-hidden relative">
      ...
      <div className="relative z-10 w-full max-w-md bg-white/4 backdrop-blur-2xl border border-white/[0.07] rounded-3xl p-10 shadow-2xl">
        ...
        <h1
          className="text-[26px] font-extrabold text-white/90 tracking-tight leading-tight mb-1"
          style={{ fontFamily: "Syne, sans-serif" }}
        >
          Create your account
        </h1>
        <p className="text-sm text-white/40 mb-7 font-light">
        ...
        <form className="flex flex-col gap-4" onSubmit={handleSubmit(onsubmit)}>
          ...
          <div>
            ...
            <div className="relative">
              <span className="absolute left-4 top-1/2 -translate-y-1/2 text-white/25 text-sm font-medium">
                @
              </span>
              <input
                type="text"
          ...
          <div>
            <label className="block text-[13px] font-medium text-white/45 mb-1.5 tracking-wide">
              Full name{" "}
              <span className="text-white/20 text-[11px] font-normal ml-1">
                optional
              </span>
            </label>
            <input
