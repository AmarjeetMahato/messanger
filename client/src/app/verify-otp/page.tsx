...
const VerifyOTP = () => {
  ...
  const [verifyToken] = useEmailVerificationMutation();
    ...
    return (
      <div className="min-h-screen bg-[#070711] flex items-center justify-center px-4 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          ...
          <h2
            className="text-2xl font-extrabold text-white/90 mb-2"
            style={{ fontFamily: "Syne, sans-serif" }}
          >
            Account verified!
          </h2>
          <p className="text-white/40 text-sm">
            Welcome to VibeChat. You&apos;re all set.
          </p>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-[#070711] flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md bg-white/4 backdrop-blur-2xl border border-white/[0.07] rounded-3xl p-10 shadow-2xl">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <span
            className="text-[19px] font-extrabold text-white/90 tracking-tight"
            style={{ fontFamily: "Syne, sans-serif" }}
          >
        ...
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <h1
            className="text-[24px] font-extrabold text-white/90 tracking-tight mb-1"
            style={{ fontFamily: "Syne, sans-serif" }}
          >
            Check your email
          </h1>
          ...
          <div className="flex items-center justify-center gap-1.5">
            ...
            {canResend ? (
              ...
              <span className="text-sm text-white/25 font-medium">
                Resend in{" "}
                <span className="text-indigo-400/70 tabular-nums">
        ...
        <div
          onClick={handleBack}
          className="mt-6 pt-5 border-t border-white/6 flex items-center justify-center gap-2"
        >
          <svg
            width="14"
            height="14"
